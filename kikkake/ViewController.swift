...
//  kikkake
//
//  Created by 鈴木裕太 on 2019/11/30.
//  Copyright © 2019 きっかけレシピ. All rights reserved.
//
...
class ViewController: UIViewController, AVCaptureVideoDataOutputSampleBufferDelegate {
    ...
    private(set) var timerTotalDuration: TimeInterval = 0    // 総秒数
    ...
    // MARK: ウェブページ表示
    func loadWebPage() {
        if let url = NSURL(string: "https://kikkake.mybluemix.net") {
...
//        guard timer == nil else { return }
    ...
    @objc private func handleTimer(_ timer: Timer) {
        ...
        self.timerLabel.text = Int(timerTotalDuration).description
    }
